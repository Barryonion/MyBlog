...
![image-20220620103225148](Uniswap去中心化交易所究竟是什么？/image-20220620103225148.png)
...
![image-20220621173336014](Uniswap去中心化交易所究竟是什么？/image-20220621173336014.png)
...
![image-20220616220954534](Uniswap去中心化交易所究竟是什么？/image-20220616220954534.png)

随后根据如下参数配置进行编译

![image-20220616152107943](Uniswap去中心化交易所究竟是什么？/image-20220616152107943.png)

然后再部署合约，部署地址填写为发起本次部署的账户地址。![image-20220616153638110](Uniswap去中心化交易所究竟是什么？/image-20220616153638110.png)

部署成功后，复制工厂合约地址。

![image-20220616153754560](Uniswap去中心化交易所究竟是什么？/image-20220616153754560.png)
...
![image-20220616154301862](Uniswap去中心化交易所究竟是什么？/image-20220616154301862.png)

如上图所示，填写工厂合约地址，WETH合约地址（Rinkeby网络固定为0xc778417E063141139Fce010982780140Aa0cD5Ab）。

随后点击`INIT_CODE_PAIR_HASH`按钮，获取并复制返回的哈希值

![image-20220616221156429](Uniswap去中心化交易所究竟是什么？/image-20220616221156429.png)

将前缀`0x`去掉后，替换到下图所示位置。

![image-20220616222516463](Uniswap去中心化交易所究竟是什么？/image-20220616222516463.png)
...
![image-20220616165700715](Uniswap去中心化交易所究竟是什么？/image-20220616165700715.png)

启动成功后如下图所示：

![image-20220616165558353](Uniswap去中心化交易所究竟是什么？/image-20220616165558353.png)
...
![image-20220616173341712](Uniswap去中心化交易所究竟是什么？/image-20220616173341712.png)
...
![image-20220616213743296](Uniswap去中心化交易所究竟是什么？/image-20220616213743296.png)
...
![image-20220620220751427](Uniswap去中心化交易所究竟是什么？/image-20220620220751427.png)

随后点击`Select Token`

![image-20220620220852383](Uniswap去中心化交易所究竟是什么？/image-20220620220852383.png)

在弹出的对话框中粘贴我们刚刚发行的`Bai Li Coin`的地址

![image-20220620221115149](Uniswap去中心化交易所究竟是什么？/image-20220620221115149.png)

点击`Add`进行添加，然后选中。

输入要添加的数量（由于之前添加过，所以这里根据之前的比例自动计算出各自所需的个数）

![image-20220620221414083](Uniswap去中心化交易所究竟是什么？/image-20220620221414083.png)

点击`Approve BLC`进行审批，在Metamask中点击确认。

![image-20220620221723881](Uniswap去中心化交易所究竟是什么？/image-20220620221723881.png)

上图表示确认通过，随后点击`Supply`

![image-20220620221800451](Uniswap去中心化交易所究竟是什么？/image-20220620221800451.png)

再点击`Comfirm Supply`，可以看到本次添加流动性，我们可以得到3.125个LP token。

![image-20220620221838325](Uniswap去中心化交易所究竟是什么？/image-20220620221838325.png)

执行成功后，刷新页面，我们可以看到添加的流动性列表

![image-20220620222500357](Uniswap去中心化交易所究竟是什么？/image-20220620222500357.png)
...
![image-20220620222907144](Uniswap去中心化交易所究竟是什么？/image-20220620222907144.png)

我们打算用0.01个ETH来换取8.8709个BLC。

![image-20220620223106163](Uniswap去中心化交易所究竟是什么？/image-20220620223106163.png)

点击`Swap Anyway`

![image-20220620223229423](Uniswap去中心化交易所究竟是什么？/image-20220620223229423.png)

根据提示，点击OK。

![image-20220620223356399](Uniswap去中心化交易所究竟是什么？/image-20220620223356399.png)

可以看到交易已经成功执行

![image-20220620223424605](Uniswap去中心化交易所究竟是什么？/image-20220620223424605.png)
...
![image-20220620223820040](Uniswap去中心化交易所究竟是什么？/image-20220620223820040.png)

将数量调成100%，选择移除所有流动性，随后点击`Approve`按钮进行审核

![image-20220620223913678](Uniswap去中心化交易所究竟是什么？/image-20220620223913678.png)

审核通过后点击`Remove`

![image-20220620224025852](Uniswap去中心化交易所究竟是什么？/image-20220620224025852.png)

再点击`Confirm`

![image-20220620224053957](Uniswap去中心化交易所究竟是什么？/image-20220620224053957.png)

随后在Metamask中确认交易，根据提示可看到执行成功

![image-20220620224144280](Uniswap去中心化交易所究竟是什么？/image-20220620224144280.png)

返回Pool页面，发现流动性已经移除。

![image-20220620224217244](Uniswap去中心化交易所究竟是什么？/image-20220620224217244.png)
...
![image-20220623221106167](Uniswap去中心化交易所究竟是什么？/image-20220623221106167.png)
...
![image-20220617164933905](Uniswap去中心化交易所究竟是什么？/image-20220617164933905.png)

`addLiquidityETH`的代码执行逻辑如下：

![image-20220621120708198](Uniswap去中心化交易所究竟是什么？/image-20220621120708198.png)

`_addLiquidity`方法的详细计算逻辑如下：

![image-20220621121350025](Uniswap去中心化交易所究竟是什么？/image-20220621121350025.png)

工厂合约中`createPair`的详细计算逻辑如下：

![image-20220621121920092](Uniswap去中心化交易所究竟是什么？/image-20220621121920092.png)

回到`addLiquidityETH`方法，通过Pair合约的`mint`方法来铸造流动性代币，并发到用户地址中。

![image-20220621125619554](Uniswap去中心化交易所究竟是什么？/image-20220621125619554.png)

在`_update`方法中把余额更新到储备量中

![image-20220621130010341](Uniswap去中心化交易所究竟是什么？/image-20220621130010341.png)
